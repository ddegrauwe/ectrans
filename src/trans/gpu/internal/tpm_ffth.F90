...
MODULE TPM_FFTH
 ...
 SUBROUTINE EASRE1B_HIP_INTERNAL(PFFT, FOUBUF_IN, D_NPNTGTB1, K_NPNTGTB1, R_NDGL, D_NUMP,  KJGL, KJM, KFIELD) 
     ...
     INTERFACE
         SUBROUTINE EASRE1B_HIPH(PFFT, FOUBUF_IN, D_NPNTGTB1, K_NPNTGTB1, R_NDGL, D_NUMP,  KJGL, KJM, KFIELD) bind(c, NAME="easre1b_hiph_")
             USE, INTRINSIC:: ISO_C_BINDING
     ...
     CALL EASRE1B_HIPH(c_loc(PFFT), c_loc(FOUBUF_IN), c_loc(D_NPNTGTB1), K_NPNTGTB1, R_NDGL, D_NUMP, KJGL, KJM, KFIELD)
     
     !$ACC END HOST_DATA
     

 END SUBROUTINE EASRE1B_HIP_INTERNAL

 
 SUBROUTINE EASRE1B_HIP(PFFT, FOUBUF_IN, D_NPNTGTB1, R_NDGL, D_NUMP, KFIELD) 
    ...
    CALL EASRE1B_HIP_INTERNAL(PFFT(1,1,1), FOUBUF_IN(1), D_NPNTGTB1(1,1), K_NPNTGTB1, R_NDGL, D_NUMP, KJGL, KJM, KFIELD)
